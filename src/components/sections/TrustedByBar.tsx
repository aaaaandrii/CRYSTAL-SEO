...
const partnerLogos = [
  ...
  { src: '/logos/ASTROLAB.png', alt: 'Astrolab', width: 166, height: 43, scale: 1 },
    ...
    <section className="border-y border-black/10 bg-[#e4e8ef] px-4 py-5 sm:px-[50px] sm:py-7">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
          {/* Label */}
          <div className="shrink-0 sm:border-r sm:border-[#d0d0d0] sm:pr-6">
            <p className="text-[12px] font-semibold uppercase text-black">
              Trusted by:
            </p>
          </div>
          {/* Logos — wrap on mobile, single row on desktop */}
